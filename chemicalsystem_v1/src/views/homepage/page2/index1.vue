...
<!--        上面的添加操作-->
        <div>
            ...
            <el-form :inline="true" :model="insertUsertableData" :rules="rules" ref="insertUsertableData" class="demo-form-inline">
                <el-form-item label="人员姓名" prop="username">
                    <el-input size="small" v-model="insertUsertableData.username" placeholder="请输入姓名"></el-input>
                </el-form-item>
                <el-form-item label="人员账号" style="margin-left: 3.2vw" prop="usernumber">
                    <el-input size="small" v-model="insertUsertableData.usernumber" placeholder="请输入账号"></el-input>
                </el-form-item>
                <el-form-item label="人员密码" style="margin-left: 3.2vw" prop="password">
                    <el-input size="small" v-model="insertUsertableData.password" placeholder="请输入密码"></el-input>
                </el-form-item>
                <el-form-item label="身份类型" style="margin-left: 3.2vw" prop="userrole">
                    <el-select size="small" v-model="insertUsertableData.userrole" placeholder="请选择身份类别">
            ...
            <div class="divinsertbutton">
                <el-button size="small" type="primary" @click="submitForm('insertUsertableData')" style="width: 5.2vw">添加</el-button>
                <el-button size="small" @click="resetForm('insertUsertableData')" style="width: 5.2vw; margin-left: 3vw;">清空</el-button>
            </div>
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <el-tag
                                    ...
                                    disable-transitions>{{scope.row.userrole}}</el-tag>
                        </template>
                    </el-table-column>
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        const _this = this;
                        axios.post(api123.baseURL + '/addsystemuser', this.insertUsertableData).then(function (resp) {
