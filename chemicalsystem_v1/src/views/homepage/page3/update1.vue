  ...
  <div>
    ...
    >
      ...
      <el-form-item label="设备名称" prop="equipment_name">
        <el-input v-model="ruleForm.equipment_name"></el-input>
      </el-form-item>
      <el-form-item label="设备类型" prop="equipment_type">
        <el-input v-model="ruleForm.equipment_type"></el-input>
      </el-form-item>
      ...
      <el-form-item label="药品柜" prop="equipment_position">
        <el-input v-model="ruleForm.equipment_position"></el-input>
      </el-form-item>
...
export default {
      ...
      this.$refs[formName].validate((valid) => {
        ...
        if (valid) {
          if (this.ruleForm.equipment_number > 0) {
            axios
              .post(api123.baseURL + "/Laboratoryequipmentmanagement/updateequipment/", this.ruleForm)
              .then(function (resp) {
                if (resp.data == "修改设备信息成功") {
                  _this.$alert("修改成功！", "消息", {
  ...
  created() {
    ...
    axios
      .get(api123.baseURL + "/Laboratoryequipmentmanagement/findById/" + this.$route.query.id)
      .then(function (resp) {
        _this.ruleForm = resp.data.laborequipResult;
